...
//source: https://www.codexworld.com/generate-qr-code-php-google-chart-api/
...
class QRGenerator
{
    ...
    public function qrCode($size = 200, $filename = null) {
        ...
        curl_setopt($ch, CURLOPT_POSTFIELDS, "chs={$size}x{$size}&cht=qr&choe=UTF-8&chl=".urlencode($this->codeData));
