	...
	$('.previous_qualification').on('click', function() {
		...
		// $("#area_previous_institution").html('');
	  	...
	  	if ( qualification_id == 1 )
	  	{
	  		...
	  		// $("#area_previous_result").html('<label for="previous_result">SPM result <?=STARFIELD;?></label><input type="text" name="previous_result" id="previous_result" parsley-trigger="change" required placeholder="SPM result" class="form-control turn_uppercase" />');

	  		// $("#area_previous_institution").html('<label for="previous_institution">Which Secondary School did you attend? <?=STARFIELD;?></label><input type="text" name="previous_institution" id="previous_institution" parsley-trigger="change" required placeholder="Which Secondary School did you attend?" class="form-control turn_uppercase" />');
	  	}
	  	else
	  	{
	  		$("#area_qualification_1").hide();
	  		$("#area_qualification_2").show();
	  		// $("#area_previous_result").html('<label for="previous_result">CGPA result <?=STARFIELD;?></label><input type="text" name="previous_result" id="previous_result" parsley-trigger="change" required placeholder="CGPA result" class="form-control input_decimal" />');

	  		// $("#area_previous_institution").html('<label for="previous_institution">Which college or university did you attend? <?=STARFIELD;?></label><input type="text" name="previous_institution" id="previous_institution" parsley-trigger="change" required placeholder="Which college or university did you attend?" class="form-control turn_uppercase" />');
	  	}
	});
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card-box">
  				...
  				<div class="panel-heading" style="background-color: #e2e2e2 !important;"><h4 style="color:#000000 !important;">Scholarship Details</h4></div>
   				<div class="panel-body">
		            ...
		            <p class="font-14 m-b-5">
		  				...
		  				<ol>
		  					<li>PMR and SPM result certificates</li>
			...
			<form id="application_form" name="application_form" action="<?=site_url("booking-submit"); ?>" method="post" enctype="multipart/form-data">

				<ul class="nav nav-tabs tabs-bordered">
                    <li class="nav-item active">
                        <a href="#applicant_info" data-toggle="tab" aria-expanded="true" class="nav-link active">
                            Applicant Information
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#applicant_attachment" data-toggle="tab" aria-expanded="false" class="nav-link">
                            Attachment
                        </a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="applicant_info">

                    	<div class="col-md-6">
			                <div class="form-group">
			                    <label for="applicant_name">Full Name <?=STARFIELD;?></label>
			                    <input type="text" name="applicant_name" id="applicant_name" parsley-trigger="change" required placeholder="Full Name" class="form-control turn_uppercase" />
			                </div>
			                <div class="form-group">
			                    <label for="applicant_dob">Date of Birth <?=STARFIELD;?></label>
			                	<input type="text" name="applicant_dob" id="datepicker-applicant_dob" parsley-trigger="change" required placeholder="dd/mm/yyyy" class="form-control" />
			                </div>
			                <div class="form-group">
			                    <label for="applicant_icno">IC Number <?=STARFIELD;?></label>
			                    <input type="text" name="applicant_icno" id="applicant_icno" parsley-trigger="change" required placeholder="IC Number" class="form-control mask_nric" />
			                </div>
			                <div class="form-group">
			                    <label for="applicant_phoneno">Phone Number <?=STARFIELD;?></label>
			                    <input type="text" name="applicant_phoneno" id="applicant_phoneno" parsley-trigger="change" required placeholder="Phone Number" class="form-control mask_phone" />
			                </div>
			                <div class="form-group">
			                    <label for="applicant_email">Email Address <?=STARFIELD;?></label>
			                    <input type="email" name="applicant_email" id="applicant_email" parsley-trigger="change" required placeholder="Email Address" class="form-control" />
			                </div>
			                <div class="form-group">
			                    <label for="applicant_permanent_address">Permanent Address <?=STARFIELD;?></label>
			                    <textarea name="applicant_permanent_address" id="applicant_permanent_address" rows="5" style="resize: none; margin-top: 0px; margin-bottom: 0px; height: 100px; " parsley-trigger="change" required placeholder="Permanent Address" class="form-control turn_uppercase"></textarea>
			                </div>
			                ...
			                <div class="form-group">
				                ...
				                <div class="form-group race_other_input default_hide">
				                    <input type="text" name="race_other" id="race_other" parsley-trigger="change" required placeholder="Please State Other Race" class="form-control turn_uppercase" />
				                </div>
			                </div>
			                ...
			                <div id="area_qualification_1">
				                <div class="form-group" id="area_previous_result">
				                	<label for="previous_result">SPM result <?=STARFIELD;?></label><input type="text" name="previous_result" id="previous_result" parsley-trigger="change" required placeholder="SPM result" class="form-control turn_uppercase" />
				                </div> 
				                <div class="form-group" id="area_previous_institution">
				                	<label for="previous_institution">Which Secondary School did you attend? <?=STARFIELD;?></label><input type="text" name="previous_institution" id="previous_institution" parsley-trigger="change" required placeholder="Which Secondary School did you attend?" class="form-control turn_uppercase" />
				                </div>
				            </div>

				            <div id="area_qualification_2" class="default_hide">
				                <div class="form-group" id="area_previous_result">
				                	<label for="previous_result">CGPA result <?=STARFIELD;?></label><input type="text" name="previous_result" id="previous_result" parsley-trigger="change" required placeholder="CGPA result" class="form-control input_decimal" />
				                </div> 
				                <div class="form-group" id="area_previous_institution">
				                	<label for="previous_institution">Which college or university did you attend? <?=STARFIELD;?></label><input type="text" name="previous_institution" id="previous_institution" parsley-trigger="change" required placeholder="Which college or university did you attend?" class="form-control turn_uppercase" />
				                </div>
				            </div>

			                <div class="form-group">
			                    <label for="household_income">What is your household combined income? <?=STARFIELD;?></label>
			                    <input type="text" name="household_income" id="household_income" parsley-trigger="change" required placeholder="What is your household combined income?" class="form-control input_decimal" />
			                </div>
			            </div>
			             
			            <div class="col-md-6">
			                <div class="form-group">
			                    <label for="applicant_phoneno">Which Education Institution of Study are you interested in? <?=STARFIELD;?></label>
								<?php
			                    	$institution_other = -1;
		                        ...
		                        <div class="checkbox checkbox-success">
			                     ...
			                     <div class="form-group institution_other_input default_hide">
				                    <input type="text" name="institution_other" id="institution_other" parsley-trigger="change" required placeholder="Please State Other Institution" class="form-control turn_uppercase" />
				                </div>
			                </div>

			                <div class="form-group">
			                    <label for="applicant_phoneno">Which Course of Study are you interested in? <?=STARFIELD;?></label>
								<?php
			                    	$course_other = -1;
		                        ...
		                        <div class="checkbox checkbox-success">
			                     ...
			                     <div class="form-group course_other_input default_hide">
				                    <input type="text" name="course_other" id="course_other" parsley-trigger="change" required placeholder="Please State Other Course" class="form-control turn_uppercase" />
				                </div>
			                </div>

			                <div class="form-group">
			                    <label for="course_duration">Duration of Course (months) <?=STARFIELD;?></label>
			                    <input type="text" name="course_duration" id="course_duration" parsley-trigger="change" required placeholder="Duration of Course (months)" class="form-control input_integer" />
			                </div>

			                <div class="form-group">
			                    <label for="study_start_date">Intended Start Date <?=STARFIELD;?></label>
			                	<input type="text" name="study_start_date" id="datepicker-study_start_date" parsley-trigger="change" required placeholder="dd/mm/yyyy" class="form-control" />
		                    </div> 
			            </div>

                    </div> 
                    <!-- end tab applicant_info --> 

					
                    <div class="tab-pane" id="applicant_attachment">

			            <div class="col-md-6">
			                <div class="form-group">
								<label for="attachment_qualification">Previous Qualification Result Certificates <?=STARFIELD;?></label>
		                        <input type="file" id="attachment_qualification" name="attachment_qualification" parsley-trigger="change" required class="form-control" multiple="multiple" />
		                     ...
		                     <div class="form-group">
		                        ...
		                        <input type="file" id="attachment_ic" name="attachment_ic" parsley-trigger="change" required class="form-control" multiple="multiple" />
								<span class="help-block text-info">
		                     ...
		                     <div class="form-group">
		                        ...
		                        <input type="file" id="attachment_household_income" name="attachment_household_income" parsley-trigger="change" required class="form-control" multiple="multiple" />
								<span class="help-block text-info">
                	...
                	<!-- end tab applicant_attachment --> 
                	
	                <div class="form-group text-right m-t-30 m-b-50">
	                    <button type="submit" id="btn_submit" name="btn_submit"  class="btn btn-success waves-effect waves-light">
	                        Submit
	                    </button>
